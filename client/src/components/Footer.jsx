      ...
      <div className="container">
          ...
          >
            <div className="footer-logo-section">
              <div className="footer-logo-container">
                <h3 className="footer-logo-text">4Pixels</h3>
              </div>
              <p className="footer-tagline">Digital Agency</p>
            </div>
        ...
        <div className="footer-bottom">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            &copy; {new Date().getFullYear()} 4Pixels. {language === 'en' ? 'All rights reserved.' : 'جميع الحقوق محفوظة.'}
          </motion.div>
        </div>
      </div>
    </footer>
